...
export default function ServiceModalButton({serviceName, isDisabled, isBadge, title, content}: ServiceModalButtonProps): JSX.Element {
    ...
    <>
      {isBadge ? (
          <Badge content="신규" color="danger">
            <Tooltip color={"warning"} closeDelay={1000}
                     content={
                     ...
                     placement={"bottom"}>
              <Button className={buttonStyle} radius="sm" size="lg" isDisabled={isDisabled}>
                {serviceName}
              </Button>
            </Tooltip>
          </Badge>
